      ...
      <main>
        <div className="profil__infos">
          <img
            className="info-img "
            src={
              user.image ? user.image : '../../assets/img/Avatar_anonyme.png'
            }
            alt="Photo de profil"
          />
        ...
        <div className="profil__social">
          <div className="social">
            <p>
              {events.length} {events.length < 2 ? 'event' : 'events'}
            </p>
          </div>
      ...
      {clickSetting ? (
        <div className="modal__setting">
          <div className="modal__btn">
            ...
            <p className="modal__btn-delete" onClick={handleClickDeleteModal}>
              Supprimer
            </p>
          </div>
        </div>
        ...
        <div className="modal__delete">
          <div className="modal__delete-validation">
            <p className="modal__delete-message">
              <span>Attention</span>: Voulez-vous vraiment supprimer votre
              compte ?
            </p>
